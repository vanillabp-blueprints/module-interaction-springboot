...
public class Workflow {
   ...
   * <code>bpmn:message</code> in the model, and there is no second place it is written down.
   */
  public static final String RISK_ASSESSED = "RiskAssessed";
  ...
  /**
   * The risk assessment answered, which is what the process waits for.
   *
   * <p>
